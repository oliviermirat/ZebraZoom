...
You also have the option of putting the parameter "postProcessMultipleTrajectories" to a very high value which will have the effect of only modifying the values (x, y) for frames for which no detection occured at all.<br/>
