...
from zebrazoom.code.tailTracking import TailTrackingExtremityDetectMixin
...
class _BaseFasterMultiprocessing(BaseTrackingMethod):
...
class FasterMultiprocessing(_BaseFasterMultiprocessing, EyeTrackingMixin, GetImagesMixin):
  def __init__(self, videoPath, background, wellPositions, hyperparameters):
...
class FasterMultiprocessing2(_BaseFasterMultiprocessing, TailTrackingExtremityDetectMixin):
  def __init__(self, videoPath, background, wellPositions, hyperparameters):
    super().__init__(videoPath, background, wellPositions, hyperparameters)
