...
class NumberOfAnimals2(QWidget):
  def __init__(self, controller):
    ...
    layout.addWidget(util.apply_style(QLabel("Tail tracking: Choose an option below:", self), font_size='16px'), 3, 1, Qt.AlignmentFlag.AlignCenter)
    ...
    layout.addWidget(recommendedMethodRadioButton, 4, 1, Qt.AlignmentFlag.AlignCenter)
    ...
    layout.addWidget(alternativeMethodRadioButton, 5, 1, Qt.AlignmentFlag.AlignCenter)
    ...
    layout.addWidget(label, 6, 1, 2, 1)
    ...
    advancedOptionsLayout.addWidget(util.apply_style(QLabel("Are all animals ALWAYS visible throughout the video?", self), font_size='16px'), 0, 0, Qt.AlignmentFlag.AlignCenter)
    ...
    yesNoLayout1.addStretch()
    advancedOptionsLayout.addLayout(yesNoLayout1, 1, 0, Qt.AlignmentFlag.AlignCenter)
